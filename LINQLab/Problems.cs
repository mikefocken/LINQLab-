...
namespace LINQLab
{
    class Problems
    {
        ...
        //         Console.WriteLine("Here is a count of all users: " + Count);
        //}
        //            /*
        //            Expected Result:
        //                User Count: 5
        ...
        //    var productsLess100 = _context.Products.Where(product => product.Price <100);
        //    Console.WriteLine("RProblemsTwo: Products $100 or less");
        //    foreach (Product product in productsLess100)
        //    {
        //        Console.WriteLine($"{product.Name}-${product.Price}");
        //    }
       ...
       */
        ...
        //    var ProductNamesThatContainS = _context.Products.Where(product => product.Name.Contains("s"));

        //    foreach (var product in ProductNamesThatContainS)
        //    {
        ...
        //    var UsersRegisterBefore2016 = _context.Users.Where(User => User.RegistrationDate < new DateTime(2016, 1, 1));

        //    foreach (var User in UsersRegisterBefore2016)
        //    {
        ...
        //    // Then print each user's email and registration date to the console.
        //    var UsersRegisterBetween2016And2017 = _context.Users.Where(User => User.RegistrationDate >= new DateTime(2016,1,1) && User.RegistrationDate <= new DateTime (2017,12,31));

        //    foreach (var User in UsersRegisterBetween2016And2017)
        //    {
        //        Console.WriteLine($"Email: {User.Email},Registration Date: {User.RegistrationDate}");
        //    }
